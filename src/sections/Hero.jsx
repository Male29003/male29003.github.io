...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative isolate px-6 pt-10 lg:px-8 min-h-[80vh]"
    >
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 lg:gap-18">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="mt-6 text-sm md:text-base lg:text-lg leading-5  text-slate-300 max-w-xl mx-auto md:mx-0">
              ...
              interfaces. Currently focusing on{" "}
              <span className="font-semibold text-highlight">
                React, Node.js with TailwindCSS
              </span>{" "}
              with an emphasis on performance and smooth UX.
            </p>
            ...
            <div className="mt-8 flex items-center justify-center md:justify-start gap-5">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.5 }}
                className="download_cv_btn px-4 md:px-7 py-2.5 rounded-full font-semibold text-sm text-white shadow-lg shadow-primary/20 bg-gradient-to-r from-primary to-accent hover:shadow-[0_0_20px_rgba(236,72,153,0.7)] transition-all duration-300 cursor-pointer"
              >
                My Resume
              </motion.a>
            </div>
